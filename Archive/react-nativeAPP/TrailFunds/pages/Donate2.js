  ...
  return (
    <View style={donatePg2Sty.parentFlexBox}>
      ...
      <View style={[donatePg2Sty.switchFlexBox, { alignItems: "flex-start" }]}>
        <Switch onValueChange={toggleSwitch1} trackColor={{true:'#59C092', false:'lightgray'}} thumbColor="#fff" value={switch1} />
      </View>
      ...
      <View style={[donatePg2Sty.switchFlexBox, { alignItems: "flex-end" }]}>
        <Switch onValueChange={toggleSwitch2} trackColor={{true:'#59C092', false:'lightgray'}} thumbColor="#fff" value={switch2} style={{}}/>
      </View>
      <View
        style={[
      ...
      <View style={[donatePg2Sty.switchFlexBox, { alignItems: "flex-end" }]}>
        <Switch onValueChange={toggleSwitch3} trackColor={{true:'#59C092', false:'lightgray'}} thumbColor="#fff" value={switch3} style={{}} />
      </View>
      <View style={[donatePg2Sty.textFlexBox, { alignItems: "flex-start" }]}>
        <Text style={[defaultSty.loved2Death, { fontSize: normalize(23) }]}>
          Your Favorate Orgs
      ...
      <View style={[donatePg2Sty.switchFlexBox, { alignItems: "flex-end" }]}>
        <Switch onValueChange={toggleSwitch4} trackColor={{true:'#59C092', false:'lightgray'}} thumbColor="#fff" value={switch4} style={{}} />
      </View>
      <View style={donatePg2Sty.centerText}>
        <PrimaryButton
          ...
          onPress={() =>
            alert(
              "We are still working on this! Come back soon for more updates!"
            )
          }
        />
      </View>
